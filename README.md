...
#### 📝 To do
- Add more content, woork, school, hobies ...
- Add a footer that shows what the page is built with, HTML, CSS, Bootstrap, JavaScrip & React ...
- Maby add som animations to the repos in the protfolio section ...
