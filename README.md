...
#### 📝 To do
- Add content to second component (Worklife.jsx) ...
- Consider more compomnent to display a bit of what I have done, can show stats and repos from Github ...
- Add som in and out animations (started in Home.jsx) ...
